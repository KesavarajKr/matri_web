...
class basicdetailsController extends Controller
{
    ...
    public function index()
    {
        ...
        $complexion1 = DB::table('complexion_tb')
         ...
         //    $count1=$count/100;
            // $count1="10";
        return view('pages.basicdetails',compact('btype_tb','phytb','complexion1','height1','matrial_tb','count1'));
    }
    ...
    public function updatebasicdetails(Request $request)
    {
        ...
        // $data = ['LoggedUserInfo'=>register::where('varan_id','=', session('LoggedUser'))->first];
        //     dd($data);
        ...
        if($updateabout)
        {
            ...
            return redirect('/basicdetails')->with('success','Basic Details Updated Successfully');
        }
