...
class aboutmeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.aboutme',compact('count1'));
    }
    ...
    function storeaboutme(Request $request)
    {
        ...
        if($updateabout)
        {
            ...
            return redirect('/aboutme')->with('success','About Updated Successfully');
        }
