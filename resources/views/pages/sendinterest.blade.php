            ...
            <div class="container">
                <div class="register-inner">
                    <div class="row">
                        ...
                        @if($sentinterest)
                        @foreach ($sentinterest as $profiles)
                            ...
                            <div class="cardbottom">
                                <div class="container-fluid">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <form method="POST" action="/cancelinterest">
                                                @csrf
                                                <input type="hidden" name="userid" value="{{$profiles->varan_id}}">
                                                <button class="btn btn-default"><img src="assets/images/ignore.png" style="width:30px" class="img-fluid"><span>Cancel Interest</span></button>
                                            </form>
