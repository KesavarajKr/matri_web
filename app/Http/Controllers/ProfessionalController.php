...
class ProfessionalController extends Controller
{
    ...
    public function index()
    {
     ...
     //    $count1=$count/100;
        ...
        return view('pages.professional',compact('country1','state1','cities1','education','job','count1'));
    }
    ...
    public function updateprofessionaldetails(Request $request)
    {
        ...
        $joblocationcountry = $request->joblocationcountry;
        $joblocationstate = $request->joblocationstate;
        $joblocationdistrict = $request->joblocationdistrict;
        $income = $request->income;
        $joblocation2 = $request->joblocation2;
        $varanid = $request->varanid;

        $updateabout= DB::table('registers')->where('varan_id',$varanid)->update(array(
            'eduction'=>$educationcat,
            'eduction_detail'=>$educationdetail,
            'job_category'=>$jobcategory,
            'job_detail'=>$jobdetail,
            'job_country'=>$joblocationcountry,
            'job_state'=>$joblocationstate,
            'job_city'=>$joblocationdistrict,
            'annual_income'=>$income,
            'job_location'=>$joblocation2,
        ));
        ...
        if($updateabout)
        {
            ...
            return redirect('/professional')->with('success','Professional Details Updated Successfully');
        }
    }
