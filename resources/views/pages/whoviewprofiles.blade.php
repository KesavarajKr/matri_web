            ...
            <div class="container">
                <div class="register-inner">
                    <div class="row">
                            ...
                            <div class="card profilebox">
                                    ...
                                    <div class="card-body">
                                        <ul class="matchesbtn">
                                            ...
                                            <li class="activematches"><a href="/whoviewprofiles" class=""><img src="assets/images/whoviewedprofile.png" class="img-fluid" style="width:25px"><span class="">Who Viewed Profiles ()</span></a></li>
                        ...
                        <div class="col-lg-9">
                            @if($whoviewedprofile)
                                @foreach ($whoviewedprofile as $profiles)
