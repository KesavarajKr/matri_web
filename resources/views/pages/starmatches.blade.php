            ...
            <div class="container">
                <div class="register-inner">
                    <div class="row">
                            ...
                            <div class="card profilebox">
                                    ...
                                    <div class="card-body">
                                        <ul class="matchesbtn">
                                            ...
                                            <li class="activematches"><a href="/starmatches" class=""><img src="assets/images/star_matches.png" class="img-fluid" style="width:25px"><span class="">Star Matches</span></a></li>
                        ...
                        <div class="col-lg-9">
                            @if($starmatches)
                                @foreach ($starmatches as $profiles)
