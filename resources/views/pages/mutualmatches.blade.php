            ...
            <div class="container">
                <div class="register-inner">
                    <div class="row">
                            ...
                            <div class="card profilebox">
                                    ...
                                    <div class="card-body">
                                        <ul class="matchesbtn">
                                            ...
                                            <li class="activematches"><a href="/mutualmatches" class=""><img src="assets/images/mutualmatches.png" class="img-fluid" style="width:25px"><span class="">Mutual Matches</span></a></li>
                        ...
                        <div class="col-lg-9">
                            @if($mutualmatches)
                                @foreach ($mutualmatches as $profiles)
                                    ...
                                    <div class="cardbottom">
                                        <div class="container-fluid">
                                            <div class="row">
                                                ...
                                                {{-- <div class="col-lg-4">
                                                    <button class="btn btn-default m-auto d-block"><img src="assets/images/ignore.png" style="width:30px" class="img-fluid"><span>Ignore</span></button>
                                                </div> --}}
                                            </div>
                                        </div>
                                    </div>
