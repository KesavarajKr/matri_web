...
@section('main-content')
    ...
    <section class="register-section">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 " >
                        <img src="assets/images/image 4.png" class="img-fluid loginotp" style="padding:0px;margin-top:10px;border-radius:50px 0px 0px 50px;width:100%;height:380px">
                    </div>
                    <div class="col-lg-8 ">
                        <div class="form-container">
                            <div class="container">
                               <h3 class="text-center text-white">Verify Your Phone number</h3>
                                ...
                                <form method="POST" action="/logotpcheck">
                                    @csrf
                                <div class="textbox">
