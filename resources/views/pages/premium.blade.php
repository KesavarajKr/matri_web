                        ...
                        <div class="col-lg-3 align-items-center text-center">
                            <div class="card profilebox">
                                    ...
                                    <div class="card-body">
                                        <ul class="matchesbtn">
                                            {{-- {{$varanid}} --}}
                                            <li><a href="" class="activematches">Premium Matches ({{$premium->count()}})</a></li>
                                            <li><a href="" class="">New Matches (10)</a></li>
                                            <li><a href="" class="">Mutual Matches (10)</a></li>
                                            <li><a href="" class="">Daily Matches (10)</a></li>
                                            <li><a href="" class="">Location Matches (10)</a></li>
                                            <li><a href="" class="">Professional Matches (10)</a></li>
                                            <li><a href="" class="">Star Matches (10)</a></li>
                                            <li><a href="" class="">Education Matches (10)</a></li>
                                        </ul>
